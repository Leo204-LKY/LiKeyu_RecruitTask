...
| *10/28* | *未进行学习* | - | - |  
| *10/29* | *未进行学习* | - | - |  
| 10/30 | 意外而又十分遗憾地得知战队的招新因为一些原因暂时停止。初三毕业有幸现场观摩了一场 RoboMaster 比赛，也因此希望未来能加入一个这样的战队，登上比赛的擂台。单片机（以及电路设计）我很早就想进行相关学习，无奈自己没有一个学习的方向和渠道，再加上本身就懒，一直没有着手学习，直到九月份有了目标和方向，开始学习 C 语言和单片机。。<br>很感谢这一个多月的招新任务，无论是否加入战队我都能有所收获。而且，我认为，只要克服了这个阻力，有了一个开始，后面的坚持就会简单许多。<br>接下来我还会继续学习 C 语言和单片机，虽然不会在这里继续每日汇报学习情况 (不过 [Code-Learning](https://github.com/Leo204-LKY/Code-Learning) 还是会时不时更新)，速度也会有所放缓，但我也会继续完成任务，不论是为了未来重启的招新，或是作为自己学习路上的目标，检验成果。<br>文笔不好，也不会说什么很抒情或者很华丽的话语，甚至语法错误都不知道有没有…还请见谅。感谢阅读。 | - | - |  
